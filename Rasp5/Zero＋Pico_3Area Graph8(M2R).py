...
plot_data(start_time="2024-08-27 22:30:00",
          y_scales={'CO2': (400, 900), 'Temperature': (22, 42), 'Humidity': (35, 85), 'Pressure': (993, 1005),
                    'GasResistance': (10000, 150000), 'GasResistance Normalized': (0.5, 1.8),
                    'Absolute Humidity': (0, 30)})
